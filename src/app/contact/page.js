            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:audumbershirodkar28@gmail.com" className="hover:text-red-400 transition-all duration-300 text-lg">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="https://github.com/audumber28" target="_blank" rel="noopener noreferrer" className="hover:text-red-400 transition-all duration-300 text-lg">
          ...
          <div className="backdrop-blur-sm bg-black bg-opacity-30 p-6 rounded-xl border border-gray-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <button 
                  className="bg-gradient-to-r from-red-700 to-red-500 hover:from-red-800 hover:to-red-600 text-white px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center"
                  type="submit"
              ...
              {formStatus.message && (
                <div className={`mt-4 p-3 rounded-md ${formStatus.type === 'success' ? 'bg-green-900 text-green-200' : 'bg-red-900 text-red-200'}`}>
                  {formStatus.message}
                </div>
              )}
            </form>
